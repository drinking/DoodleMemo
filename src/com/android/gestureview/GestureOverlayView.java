...
public class GestureOverlayView extends FrameLayout {
    ...
    //private int mCertainGestureColor = 0xFFFFFFFF;
 ...
 /*       TypedArray a= context.obtainStyledAttributes(attrs,R.styleable.GestureView, defStyle, 0);

        mGestureStrokeWidth = a.getFloat(R.attr.gestureStrokeWidth,
                mGestureStrokeWidth);
           mInvalidateExtraBorder = Math.max(1, ((int) mGestureStrokeWidth) - 1);
        mCertainGestureColor = a.getColor(R.attr.gestureColor,
                mCertainGestureColor);
        mUncertainGestureColor = a.getColor(R.attr.uncertainGestureColor,
                mUncertainGestureColor);
        mFadeDuration = a.getInt(R.attr.fadeDuration, (int) mFadeDuration);
        mFadeOffset = a.getInt(R.attr.fadeOffset, (int) mFadeOffset);
        mGestureStrokeType = a.getInt(R.attr.gestureStrokeType,
                mGestureStrokeType);
        mGestureStrokeLengthThreshold = a.getFloat(
        		R.attr.gestureStrokeLengthThreshold,
                mGestureStrokeLengthThreshold);
        mGestureStrokeAngleThreshold = a.getFloat(
        		R.attr.gestureStrokeAngleThreshold,
                mGestureStrokeAngleThreshold);
        mGestureStrokeSquarenessTreshold = a.getFloat(
        		R.attr.gestureStrokeSquarenessThreshold,
                mGestureStrokeSquarenessTreshold);
        mInterceptEvents = a.getBoolean(R.attr.eventsInterceptionEnabled,
                mInterceptEvents);
        mFadeEnabled = a.getBoolean(R.attr.fadeEnabled,
                mFadeEnabled);
        mOrientation = a.getInt(R.attr.orientation, mOrientation);
...
*/
    ...
    public void setGesturePaint(Paint inpaint)
    {
    	mGesturePaint.set(inpaint);
    }
        ...
        if (dx >= GestureStroke.TOUCH_TOLERANCE || dy >= GestureStroke.TOUCH_TOLERANCE) {
            ...
            if (mHandleGestureActions && !mIsGesturing) {
                ...
                if (mTotalLength > mGestureStrokeLengthThreshold) {
                    final com.android.gestureview.OrientedBoundingBox box =
