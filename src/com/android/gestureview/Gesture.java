...
public class Gesture implements Parcelable {
    ...
    public Bitmap toBitmap(int width, int height, int inset, Paint inpaint) {
        final Bitmap bitmap = Bitmap.createBitmap(width, height,
                Bitmap.Config.ARGB_8888);
        final Canvas canvas = new Canvas(bitmap);
        Paint paint=new Paint(inpaint);
        paint.setAntiAlias(BITMAP_RENDERING_ANTIALIAS);
        paint.setDither(BITMAP_RENDERING_DITHER);
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeJoin(Paint.Join.ROUND);
    ...
    public static final Parcelable.Creator<Gesture> CREATOR = new Parcelable.Creator<Gesture>() {
        public Gesture createFromParcel(Parcel in) {
            ...
            try {
                ...
                Log.e("xxxx", "Error reading Gesture from parcel:", e);
            } finally {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        final ByteArrayOutputStream byteStream =
                new ByteArrayOutputStream(32 * 1024);//GestureConstants.IO_BUFFER_SIZE
        ...
        try {
            ...
            Log.e("xxxx", "Error writing Gesture to parcel:", e);
        } finally {
